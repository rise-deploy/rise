...
class RiseAPI {
    ...
    // (e.g. "this template binds a privileged port and may fail here"). Each
    // field is type-guarded with a safe, permissive default on any failure, so
    // a backend change can't break the UI.
