...
# The zone is an input, not a resource here: see `dns_zone_id`. Nothing in this
# file creates or reads it, which is deliberate -- a data source would be read
# at plan time and needs credentials, and the plan tests run without any.
