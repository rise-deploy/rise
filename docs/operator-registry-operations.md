...
Rise uses `{tag}/** + _uploads/** + sha256*/*` — the tightest scope that works for both push methods. The test script is available at [`scripts/jfrog-scope-test.py`](../scripts/jfrog-scope-test.py).
